            ...
            if(err)
            {
                ...
                if(Meteor.isServer){
                    ...
                    esClient.update({
                        ...
                        if (error) {
                            logger.error("Error updating comment count in the index for the post: "+dpostId);
                        }
                        else{
                            logger.info("Updated comment count in the index for the post: "+dpostId + " successfully");
                        }
                    });
                }
            }
